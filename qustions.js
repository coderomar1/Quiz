...
const arr = [
    ...
    new Choices("Scrum elements consist of :"," Roles , Artifacts and Meeting"," Developers , Scrum master , Sprint backlog"," backlog , product Backlog , Developers"," Not all of the above","Roles , Artifacts and Meeting"),
