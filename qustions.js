...
const arr = [
    ...
    new TrueAndFalse("in the ERP Readiness Assessment process, all planned tasks and activities must be completed",true),
    new TrueAndFalse("In the process of training employees to use the ERP system, it is preferable not to use real data",false),
